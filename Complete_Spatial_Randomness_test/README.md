* To run **calcEnv.R** you need to specify the input and output folders of the data. The default input folder is *../res_coord_scaled/* and the output folder *./resEnv_sim_comp/K_env/*
